# Ravichandran Harini — Personal Portfolio

A modern personal portfolio showcasing my AI/ML projects, technical skills, professional experience, and current learning journey.
...
git clone https://github.com/harini281/harini-portfolio.git
...
```bash
# Check TypeScript types and bundle for production
npm run build
